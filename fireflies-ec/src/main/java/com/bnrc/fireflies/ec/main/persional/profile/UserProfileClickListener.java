package com.bnrc.fireflies.ec.main.persional.profile;
...
import com.bnrc.fireflies.ui.date.DateDialogUtil;
    ...
    public void onItemClick(final BaseQuickAdapter adapter, final View view, int position) {
        ...
        switch (id) {
            case 1:
                ...
                CallbackManager.getInstance()
                        .addCallback(CallbackType.ON_CROP, new IGlobalCallback<Uri>() {
                            ...
                            public void executeCallback(Uri args) {
                                FirefliesLogger.d("ON_CROP", args);
                                ...
                                RestClient.builder()
                                        ...
                                        .success(new ISuccess() {
                                            ...
                                            public void onSuccess(String response) {
                                                FirefliesLogger.d("ON_CROP_UPLOAD", response);
                ...
                break;
            case 2:
                final FirefliesDelegate nameDelegate = bean.getDelegate();
