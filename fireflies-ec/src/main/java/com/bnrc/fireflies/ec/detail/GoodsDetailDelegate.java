...
import com.bnrc.fireflies.animation.BezierAnimation;
import com.bnrc.fireflies.animation.BezierUtil;
...
import com.bnrc.fireflies.ui.banner.HolderCreator;
import com.bnrc.fireflies.ui.widget.CircleTextView;
...
public class GoodsDetailDelegate extends FirefliesDelegate implements
    ...
    public void onBindView(@Nullable Bundle savedInstanceState, View rootView) {
        mCollapsingToolbarLayout.setContentScrimColor(Color.WHITE); //折叠之后变成的颜色
    ...
    public void onAnimationEnd() {
        ...
        RestClient.builder()
                ...
                .success(new ISuccess() {
                    @Override
                    public void onSuccess(String response) {
                        FirefliesLogger.json("ADD", response);
