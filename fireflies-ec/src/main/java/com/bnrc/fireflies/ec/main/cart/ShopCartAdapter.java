    ...
    protected void convert(MultipleViewHolder holder, final MultipleItemEntity entity) {
        ...
        switch (holder.getItemViewType()) {
            case ShopCartItemType.SHOP_CART_ITEM:
                ...
                Glide.with(mContext)   //mContext源码里带
                        .load(thumb)
                        .apply(OPTIONS)
                        .into(imgThumb);
                ...
                if (isSelected) {
                    iconIsSelected.setTextColor
                            (ContextCompat.getColor(Fireflies.getApplicationContext(), R.color.app_main));
                } else {
                ...
                iconMinus.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (Integer.parseInt(tvCount.getText().toString()) > 1) {  //数量大于1时才可以－
                            RestClient.builder()
                                    .url("shop_cart_data")
                                    .loader(mContext)
