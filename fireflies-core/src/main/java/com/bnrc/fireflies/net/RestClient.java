...
import com.bnrc.fireflies.net.callBack.RequestCallbacks;
import com.bnrc.fireflies.net.download.DownloadHandler;
...
public class RestClient {
    ...
    private void request(HttpMethod method) {
        final RestService service = RestCreator.getRestService(); //单例模式
        ...
        if (LOADER_STYLE != null) {
            FirefliesLoader.showLoading(CONTEXT, LOADER_STYLE);
        }
