package com.bnrc.fireflies.animation;
...
import com.bnrc.fireflies.dimen.ScreenUtils;


public final class BezierAnimation {

    public static void addCart(FirefliesDelegate delegate, View start, View end,
