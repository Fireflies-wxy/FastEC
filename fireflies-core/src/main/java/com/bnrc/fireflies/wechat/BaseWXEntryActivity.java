...
public abstract class BaseWXEntryActivity extends BaseWXActivity{
    ...
    public void onResp(BaseResp baseResp) {
        ...
        authUrl
                ...
                .append(FirefliesWechat.APP_ID)
                .append("&secret=")
                .append(FirefliesWechat.APP_SECRET)
                .append("&code=")
                .append(code)
                .append("&grant_type=authorization_code");

        FirefliesLogger.d("authUrl", authUrl.toString());
        ...
        RestClient
                ...
                .success(new ISuccess() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        FirefliesLogger.d("userInfoUrl", userInfoUrl.toString());
